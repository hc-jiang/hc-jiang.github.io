...
By combining the morphology and the evolution of the stellar densities together, I am trying to reveal the relation between stellar density and stellar age. 
The data I am using is mainly from JWST near-infrared observations. Analysis shows that major star formation happened a long time ago in more compact galaxies. 
At the same time, less compact galaxies are still ongoing intense star formation. The results implies that the high-density core growth is tightly connected with quenching.
The effect of cosmic expansion, and some other mechanisms such as merger and AGN feedback may contribute to the link. 
